...
while game_active == True:
    ...
    print(Fore.CYAN  + 'CPU did a' , random.choice(trickList))
    print(Fore.WHITE + 'enter trick:')

    trickSelection = str.lower(input(Fore.YELLOW))

    if trickSelection != currentTrick:
        SKATE.insert(0, 'S')
        print('Added a letter')
        print(SKATE)
    elif trickSelection == currentTrick:
        print(SKATE)    

    if trickSelection == 'ol':
        if random.choice(odds) >= 30:
            print(Fore.GREEN + 'OLLIE 🛹 up a curb')
    ...
    if trickSelection == 'kf':
        if random.choice(odds) >= 50:
            print(Fore.GREEN + 'KICKFLIP 🛹 on flat')
            lineBonus = lineBonus + 1
            print(Fore.WHITE + 'you have', lineBonus, 'line bonus')
    ...
    if trickSelection == 'hf':
        if random.choice(odds) >= 60:
            print(Fore.GREEN + 'HEELFLIP 🛹 down 6 stair')
            lineBonus = lineBonus + 1
            print(Fore.WHITE + 'you have', lineBonus, 'line bonus')
    ...
    if trickSelection == 'bssh':
        if random.choice(odds) >= 40:
            print(Fore.GREEN + 'Shuvit 🛹 over trashcan')
            lineBonus = lineBonus + 1
            print(Fore.WHITE + 'you have', lineBonus, 'line bonus')
    ...
    if trickSelection == 'fssh':
        if random.choice(odds) >= 50:
            print(Fore.GREEN + 'Huge Front Shuvit 🛹')
            lineBonus = lineBonus + 1
            print(Fore.WHITE + 'you have', lineBonus, 'line bonus')
    
        else:
            print(Fore.RED + 'stuck it!')  
            health = health - 1
            print(health, '❣️')      
            lineBonus = 0
